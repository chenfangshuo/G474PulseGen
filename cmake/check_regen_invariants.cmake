...
if(_failed)
    ...
    message(STATUS "      处置: 先 git diff 看本次重新生成改动了什么, 恢复不该变的文件;")
    message(STATUS "      若某项配置确实需要保留, 应写进 .ioc 而不是手改生成代码 ——")
    message(STATUS "      流程见 README §9.5「改外设配置: CubeMX 重新生成」。")
    message(STATUS "      若报「提取失败」, 说明本脚本的正则已过期, 请更新它。")
