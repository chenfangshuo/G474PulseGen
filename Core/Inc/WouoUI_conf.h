...
#define SOFTWARE_DYNAMIC_REFRESH    0   //使能软件动态刷新
#define HARDWARE_DYNAMIC_REFRESH    1   //使能硬件动态刷新

#define WOUOUI_STR_LINE_SPACING     1   // 绘制字符串时行间距
#define WOUOUI_SLIDESTR_START_DELAY  50  //slidestr开始滑动的延迟大小(最大255)


//------------------与title页面相关的默认参数
#define DEFAULT_TILE_B_TITLE_FNOT           Font_8_16  // 磁贴大标题字体
#define DEFAULT_TILE_ICON_W                 60         // 磁贴图标宽度
#define DEFAULT_TILE_ICON_H                 60         // 磁贴图标高度
...
#define DEFAULT_TILE_ICON_S                 10       //磁贴图标间距(图标边和边的距离)
